...
class SettingsViewController: UIViewController, MFMailComposeViewControllerDelegate {
    ...
    func refreshViewWithSettings() {
        ...
        var isiCloudEnabled: Bool = iCloudSettings.valueForKey("isEnabled")!.isEqual(true) ? true : false
        ...
        var lastSyncEndDate: NSDate? = iCloudSettings.valueForKey("lastSuccessfulSync") as! NSDate?
    ...
    @IBAction func exportCSVButtonPressed(sender: AnyObject) {
        var textFileContentsString: NSString = self.getCSVFileString()
        var textFileContentsData: NSData = textFileContentsString.dataUsingEncoding(NSASCIIStringEncoding)!
